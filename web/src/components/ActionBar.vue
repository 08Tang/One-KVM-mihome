...
<template>
  ...
  <div ref="measureRef" aria-hidden="true" class="fixed pointer-events-none" style="visibility: hidden; top: -9999px; left: -9999px; white-space: nowrap;">
    <div class="flex items-center gap-0.5 sm:gap-1.5 px-2 sm:px-4 py-1 sm:py-1.5">
      ...
      <!-- MiHome -->
      <Button data-measure="mihome-icon" variant="ghost" size="sm" class="h-8 gap-1.5 text-xs"><Home class="size-4" /></Button>
      <Button data-measure="mihome-label" variant="ghost" size="sm" class="h-8 gap-1.5 text-xs"><Home class="size-4" />{{ t('actionbar.mihome') }}</Button>
      <!-- Paste -->
