export default {
  ...
  mihome: {
    title: '米家',
    description: '米家智能设备控制面板',
    settingsTitle: '米家集成',
    settingsDesc: '配置米家智能家居服务连接',
    enabled: '启用米家',
    enabledDesc: '开启后可在控制台访问米家设备控制面板',
    apiUrl: '接口地址',
    apiUrlPlaceholder: 'http://localhost:7123',
    apiUrlDesc: '米家服务的接口地址，默认 http://localhost:7123',
    apiKey: '接口密钥',
    apiKeyPlaceholder: '请输入密钥',
    apiKeyDesc: '用于签名验证的密钥（对应米家 config.json 中的 api_salt）',
    saveSuccess: '米家配置已保存',
    saveFailed: '保存米家配置失败',
    refreshing: '刷新中...',
  },
