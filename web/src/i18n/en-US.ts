export default {
  ...
  mihome: {
    title: 'MiHome',
    description: 'MiHome smart device control panel',
    settingsTitle: 'MiHome Integration',
    settingsDesc: 'Configure MiHome smart home service connection',
    enabled: 'Enable MiHome',
    enabledDesc: 'Enable to access MiHome device control panel from console',
    apiUrl: 'API URL',
    apiUrlPlaceholder: 'http://localhost:7123',
    apiUrlDesc: 'MiHome service API address, default http://localhost:7123',
    apiKey: 'API Key',
    apiKeyPlaceholder: 'Enter key',
    apiKeyDesc: 'Key for signature verification (corresponds to api_salt in MiHome config.json)',
    saveSuccess: 'MiHome configuration saved',
    saveFailed: 'Failed to save MiHome configuration',
